 ...
 * Displays ApperUI login interface
 */
function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-50 dark:bg-surface-900">
      <Helmet>
        ...
        <meta name="description" content="Sign in to your CareerBridge account to access your dashboard, saved jobs, and applications." />
      </Helmet>
